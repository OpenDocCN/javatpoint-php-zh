...
> 原文:[https://www.javatpoint.com/php-contact-form](https://www.javatpoint.com/php-contact-form)

在这一节中，我们将借助一些例子在 PHP 中创建一个联系人表单。在进入高级概念之前，我们先了解一下 PHP 和 Contact 表单的基础知识。

## 你说的 PHP 联系人表单是什么意思？

[PHP](https://www.javatpoint.com/php-tutorial) 中的联系表单或网页表单是每个网站中非常重要的交互和联系网站访问者的工具。它响应迅速，将适用于所有设备，如移动设备、平板电脑和其他设备。该表单包括许多选项，如电子邮件、电话号码等。

![PHP Contact Form](../Images/d0206ec37505bb693ef652238af45004.png)
...
<html lang="en">  
  ...
  <title> PHP Contact Form Example </title>
   <style>
  .error {
    color: red;
    font-weight: 400;
...
在上面的例子中，我们在 html 和 PHP 的帮助下创建了一个联系人表单。在这个表单的帮助下，用户可以输入他们的信息，然后所有者用这些信息联系访问者。

**输出:**

下面是这个例子的输出。

![PHP Contact Form](../Images/3bb4cb95cee781061c98e7cbfef1acd3.png)
