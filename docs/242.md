...
![Import and Export CSV file in Laravel 5.8](../Images/3cbd70b929ae297cc81d55c66fe73e1f.png)

现在我们必须选择 excel 文件，以便上传。在选择文件之前，我们必须创建一个 excel 文件，如下所示:

![Import and Export CSV file in Laravel 5.8](../Images/1e87e741ea5842f1a2e35490cb3c1184.png)

现在我们将选择示例. csv 文件，如下所示:

![Import and Export CSV file in Laravel 5.8](../Images/a6384aca6367ac60917f53d76a717152.png)

现在，我们将单击导入文件选项。

![Import and Export CSV file in Laravel 5.8](../Images/0015d1532f129ea8ff3ce287b43d87a0.png)
