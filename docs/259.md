...
![Laravel Google OAuth authentication using Socialite Package](../Images/d967bd53a5e59b20cd5905d878606270.png)

现在我们将点击凭证。之后，我们将选择第一个选项，OAuth。然后我们将点击名为“创建新客户端标识”的按钮。之后，我们将看到以下页面:

![Laravel Google OAuth authentication using Socialite Package](../Images/4a83796b48a3d84a904cc1ec2a2d3c0b.png)
...
![Laravel Google OAuth authentication using Socialite Package](../Images/776e00d1df7fa8e750074c64b8bd8db7.png)
